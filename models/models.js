...
const Schedule = require('./scheduleModel'); // Import the Schedule model
const { TaskStatus, TaskPriority, TaskCategory, ProjectStatus } = require('./attributesModel'); // Import Task-related models
...
User.hasMany(Schedule, { foreignKey: 'supervisor_id', as: 'SupervisedSchedules' }); // A supervisor can have many schedules
